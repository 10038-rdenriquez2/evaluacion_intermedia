...
const AddAdopterForm = ({ onAdopterSubmit }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (adopterName) {
            ...
            console.error('Debe ingresar un nombre para el profesor.');
        }
    };

    return (
        <form onSubmit={handleSubmit}>
            <input type="text" value={adopterName} onChange={(e) => setAdopterName(e.target.value)} placeholder="Nombre del Profesor 👤" />
